...
import { BotsComponent } from '../conversations/conversations.component';

@Component({
    selector: 'app-bot-details',
    standalone: true,
    imports: [TabsModule, BotsComponent],
    template: `
        <h1>{{ chatbot?.name }}</h1>
        <p-tabs value="0" [scrollable]="true">
            <p-tablist>
                <p-tab value="0"><i class="pi pi-comments"></i>Conversations</p-tab>
                <p-tab value="1"><i class="pi pi-database"></i>Training data</p-tab>
            </p-tablist>
            <p-tabpanels>
                <p-tabpanel value="0">
